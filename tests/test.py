import unittest
from flutterwave import Rave, RaveExceptions, Misc
from flutterwave.rave_exceptions import RaveError, IncompletePaymentDetailsError, AccountChargeError,TransactionVerificationError, TransactionValidationError, ServerError, CardChargeError, InitiateTransferError, SubaccountCreationError, CardCreationError
...
class TestRavePaymentOptions(unittest.TestCase):
    ...
    #     }
        ...
        # self.rave = Rave("FLWPUBK_TEST-********************-X", "FLWSECK_TEST-***************************-X", "FLWSECK_TEST**************-X", production=False, usingEnv = False)
